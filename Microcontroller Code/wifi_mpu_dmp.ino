...
const char* serverIP = "192.168.168.239";
...
{ 
  ...
  if ((mpuIntStatus & 0x10) || fifoCount == 1024) {
    ...
    mpu.resetFIFO();
    // client.println(F("FIFO overflow!"));
    ...
    String data= String(ypr[0]* 180/M_PI)+" "+String(ypr[1]* 180/M_PI)+" "+String(ypr[2]* 180/M_PI)+" "+String(dist(0))+" "+String(dist(1))+" "String(analogRead(35))+" "String(analogRead(34))+" "String(analogRead(39))+" "String(analogRead(36));
    client.println(data);
#endif
...
{
  mpu_loop();
  // client.println(String(dist(0))+" "+String(dist(1)));
  // client.println(analogRead(34));
  // client.println(analogRead(39));
